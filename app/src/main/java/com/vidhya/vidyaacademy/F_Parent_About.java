...
public class F_Parent_About extends Fragment {
    ...
    CircleImageView about_parent_img_fb, about_parent_img_youtube, about_parent_img_web, about_parent_img_call;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        about_parent_img_call = view.findViewById(R.id.about_parent_img_call);
